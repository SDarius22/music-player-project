...
class SongRepositoryTest extends BaseRepositoryTest {
  ...
  void setUp() {
    ...
    album =
        albumRepository.save(
            Album.builder().name("A Kind of Magic").artists(Set.of(artist)).build());
  ...
  void shouldReturnOnlyStreamableSongs() {
    ...
    assertThat(results)
        .allSatisfy(s -> assertThat(s.getSongType()).isEqualTo(ContentType.STREAMABLE));
  }
  ...
  void shouldReturnPublicSongsOwnedByNobody() {
    ...
    Page<Song> result =
        songRepository.findVisibleToUser("Public", user.getId(), PageRequest.of(0, 10));
  ...
  void shouldReturnOwnSongs() {
    ...
    Page<Song> result =
        songRepository.findVisibleToUser("My Upload", user.getId(), PageRequest.of(0, 10));
  ...
  void shouldNotReturnOtherUsersSongs() {
    ...
    Page<Song> result =
        songRepository.findVisibleToUser("Other's Song", user.getId(), PageRequest.of(0, 10));
  ...
  void shouldSearchByArtistName() {
    ...
    Page<Song> result =
        songRepository.findVisibleToUser("Queen", user.getId(), PageRequest.of(0, 10));
  ...
  void shouldSearchByAlbumName() {
    ...
    Page<Song> result =
        songRepository.findVisibleToUser("Kind of Magic", user.getId(), PageRequest.of(0, 10));
  ...
  void shouldBeCaseInsensitiveWhenSearchingSongs() {
    ...
    Page<Song> lower =
        songRepository.findVisibleToUser("we will", user.getId(), PageRequest.of(0, 10));
    Page<Song> upper =
        songRepository.findVisibleToUser("WE WILL", user.getId(), PageRequest.of(0, 10));
  ...
  void shouldReturnCorrectPageWhenPaginating() {
    ...
    Page<Song> page0 =
        songRepository.findVisibleToUser("Paginated", user.getId(), PageRequest.of(0, 2));
    Page<Song> page1 =
        songRepository.findVisibleToUser("Paginated", user.getId(), PageRequest.of(1, 2));
  ...
  void shouldReturnEmptyWhenNoVisibleSongsMatch() {
    ...
    Page<Song> result =
        songRepository.findVisibleToUser("zzznomatch", user.getId(), PageRequest.of(0, 10));
