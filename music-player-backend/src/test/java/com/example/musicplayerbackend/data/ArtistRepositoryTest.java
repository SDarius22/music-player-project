...
class ArtistRepositoryTest extends BaseRepositoryTest {
  ...
  void shouldPersistArtist() {
    Artist saved =
        artistRepository.save(Artist.builder().name("Led Zeppelin").hash("led-hash").build());
  ...
  void shouldMatchSubstringWhenSearchingArtistsByNameIgnoreCase() {
    ...
    Page<Artist> result =
        artistRepository.findAllByNameContainingIgnoreCase("the", PageRequest.of(0, 10));
  ...
  void shouldBeCaseInsensitiveWhenSearchingArtistsByName() {
    ...
    Page<Artist> lower =
        artistRepository.findAllByNameContainingIgnoreCase("nirvana", PageRequest.of(0, 10));
    Page<Artist> upper =
        artistRepository.findAllByNameContainingIgnoreCase("NIRVANA", PageRequest.of(0, 10));
  ...
  void shouldReturnEmptyWhenNoArtistNameMatches() {
    ...
    Page<Artist> result =
        artistRepository.findAllByNameContainingIgnoreCase("zzznomatch", PageRequest.of(0, 10));
  ...
  void shouldRespectPaginationWhenSearchingArtistsByName() {
    ...
    Page<Artist> page0 =
        artistRepository.findAllByNameContainingIgnoreCase("Band", PageRequest.of(0, 3));
    Page<Artist> page1 =
        artistRepository.findAllByNameContainingIgnoreCase("Band", PageRequest.of(1, 3));
