...
class VerificationCodeRepositoryTest extends BaseRepositoryTest {
    ...
    void shouldPersistVerificationCode() {
        VerificationCode saved = verificationCodeRepository.save(buildCode("user@example.com", "123456"));
    ...
    void shouldRemoveVerificationCodeWhenDeletedById() {
        VerificationCode saved = verificationCodeRepository.save(buildCode("del@example.com", "111222"));
    ...
    void shouldAllowMultipleCodesForSameEmail() {
        ...
        // VerificationCode has no unique constraint on email — service deletes old before saving new
