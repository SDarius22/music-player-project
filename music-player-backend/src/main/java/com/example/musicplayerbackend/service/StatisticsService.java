...
public class StatisticsService {
  ...
  public List<ChunkStatDto> getAll() {
    return chunkStatRepository.findAllByOrderByTimestampDesc().stream().map(this::toDto).toList();
  }
  ...
  public void record(ChunkStatDto dto, Long userId) {
    ...
    log.debug(
        "[STATS] Recorded chunk stat: userId={}, song='{}', local={}, cached={}, p2p={}%, total={}",
