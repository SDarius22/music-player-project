...
import 'package:music_player_frontend/features/navigation/presentation/widgets/navigation_drawer.dart';
import 'package:music_player_frontend/features/player/presentation/widgets/song_player.dart';
...
class _MainScaffoldState extends State<MainScaffold> {
            ...
            child: PopScope(
              ...
              child: GlassAnimatedScaffold(
                ...
                drawer: Drawer(
                  ...
                  child:
                      isMobile
                          ? AppNavigationDrawer(mobileDrawer: true)
                          : SizedBox.shrink(),
                ),
  ...
  Drawer buildDrawer() {
    ...
    if (isMobile) {
      return Drawer(
        backgroundColor: Colors.transparent,
        child: AppNavigationDrawer(mobileDrawer: true),
      );
    }
    return Drawer(
      backgroundColor: Colors.transparent,
