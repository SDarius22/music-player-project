...
import 'package:music_player_frontend/features/player/presentation/tabs/details_tab.dart';
import 'package:music_player_frontend/features/player/presentation/tabs/lyrics_tab.dart';
import 'package:music_player_frontend/features/player/presentation/tabs/queue_tab.dart';
import 'package:music_player_frontend/features/player/presentation/widgets/volume_control.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<AudioProvider>(
      builder: (_, audioProvider, _) {
        ...
        debugPrint(
          "Building SongPlayer, current song: ${audioProvider.currentSong!.name}",
        );
