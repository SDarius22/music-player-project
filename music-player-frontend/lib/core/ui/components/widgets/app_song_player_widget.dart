...
import 'package:music_player_frontend/core/ui/components/tabs/app_details_tab.dart';
import 'package:music_player_frontend/core/ui/components/tabs/app_lyrics_tab.dart';
import 'package:music_player_frontend/core/ui/components/tabs/app_queue_tab.dart';
import 'package:music_player_frontend/core/ui/components/theme.dart';
import 'package:music_player_frontend/core/ui/components/widgets/app_volume_widget.dart';
...
class AppSongPlayerWidget extends SongPlayerWidget {
  const AppSongPlayerWidget({super.key});

  @override
  State<SongPlayerWidget> createState() => _AppSongPlayerWidgetState();
}

class _AppSongPlayerWidgetState extends SongPlayerWidgetState {
          ...
          Opacity(
            ...
            child: SizedBox(
              ...
              child: const IgnorePointer(
                ignoring: true,
                child: AppLyricsTab(oneLine: true),
              ),
            ),
          ),
                    ...
                    return ValueListenableBuilder(
                      ...
                      builder: (context, value, child) {
                        return ProgressBar(
                          ...
                          buffered: Duration(
                            seconds:
                                audioProvider.bufferedPositionNotifier.value,
                          ),
                          total:
                              snapshot.hasData
