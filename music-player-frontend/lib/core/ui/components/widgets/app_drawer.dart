...
import 'package:music_player_frontend/core/ui/screens/app_upload_songs_screen.dart';
import 'package:music_player_frontend/core/ui/screens/app_user_settings_screen.dart';
...
class AppDrawerWidget extends DrawerWidget {
  const AppDrawerWidget({super.key});

  @override
  State<DrawerWidget> createState() => _AppDrawerWidgetState();
}

class _AppDrawerWidgetState extends DrawerWidgetState {
  ...
  List<Map<String, dynamic>> get adminMenuItems => [
    {
      ...
      "onTap": (BuildContext context) {
        ...
        context
            ...
            .innerNavigatorKey
            .currentState!
            .push(AppUploadSongsScreen.route());
      },
    },
  ];
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(
                            FluentIcons.menu,
                            size: context.read<Scaler>().scale(context, 22),
                            color: Colors.white,
                          ),
                        ),
                      ),
