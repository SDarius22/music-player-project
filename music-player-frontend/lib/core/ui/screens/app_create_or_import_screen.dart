...
class AppCreateOrImportScreen extends AbstractCreateOrImportScreen {
  static Route<void> route({
    ...
    return PageRouteBuilder(
      ...
      pageBuilder: (context, animation, secondaryAnimation) {
        return AppCreateOrImportScreen(
  ...
  AbstractCreateOrImportScreenState createState() =>
      _AppCreateOrImportScreenState();
}

class _AppCreateOrImportScreenState
    extends AbstractCreateOrImportScreenState<AppCreateOrImportScreen> {
                        ...
                        child: Container(
                          ...
                          child: MultiValueListenableBuilder(
                            ...
                            builder: (context, values, child) {
                              ...
                              return ImageWidget(
                                imageBytes: selectedSongs.isNotEmpty
