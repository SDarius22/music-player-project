...
import 'package:music_player_frontend/platforms/android/ui/screens/track_screen.dart';
...
class Tracks extends MultipleEntitiesScreen<SongProvider> {
  ...
  Widget buildHeader(BuildContext context) {
    ...
    return Container(
      ...
      child: AndroidSearchHeader(title: 'Tracks', provider: provider),
    );
  }

  @override
  EdgeInsetsGeometry buildPadding(double width, double height) {
    return EdgeInsets.only(bottom: height * 0.1);
  }
}
