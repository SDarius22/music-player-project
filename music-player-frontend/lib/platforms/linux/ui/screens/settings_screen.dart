                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text("Choose the theme of the app", style: TextStyle(
                                fontSize: smallSize,
                                fontWeight: FontWeight.normal,
                                color: Colors.grey.shade50,
                              ),),
                          ...
                          Switch(
                            ...
                            trackColor: WidgetStateProperty.all(appState.lightColor),
                            thumbColor: WidgetStateProperty.all(Colors.white),
                            thumbIcon: WidgetStateProperty.all(appState.isDarkMode ? const Icon(Icons.check, color: Colors.black,) : const Icon(Icons.close, color: Colors.black,)),
                            activeColor: Colors.white,
                          ),
