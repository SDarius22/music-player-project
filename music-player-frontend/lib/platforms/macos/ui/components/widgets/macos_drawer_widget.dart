...
import 'package:music_player_frontend/platforms/macos/ui/screens/albums.dart';
import 'package:music_player_frontend/platforms/macos/ui/screens/artists.dart';
import 'package:music_player_frontend/platforms/macos/ui/screens/playlists.dart';
import 'package:music_player_frontend/platforms/macos/ui/screens/settings_screen.dart';
import 'package:music_player_frontend/platforms/macos/ui/screens/tracks.dart';
import 'package:provider/provider.dart';

class MacosDrawerWidget extends DrawerWidget {
  const MacosDrawerWidget({super.key});

  @override
  State<DrawerWidget> createState() => _MacosDrawerWidgetState();
}

class _MacosDrawerWidgetState extends DrawerWidgetState {
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Icon(
                    item["icon"],
                    size: MacosScaler().scale(context, 24),
                    color: Colors.white,
                  ),
                ),
                if (isDrawerOpen) ...[
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(
                            FluentIcons.menu,
                            size: MacosScaler().scale(context, 22),
                            color: Colors.white,
                          ),
                        ),
                      ),
