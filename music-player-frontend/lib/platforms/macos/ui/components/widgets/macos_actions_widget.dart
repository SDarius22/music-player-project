...
class MacosActionsWidget extends ActionsWidget {
  const MacosActionsWidget({super.key});

  @override
  State<ActionsWidget> createState() => _MacosActionsWidgetState();
}

class _MacosActionsWidgetState extends ActionsWidgetState {
  @override
