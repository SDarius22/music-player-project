...
class MacosSearchHeader extends StatefulWidget {
  const MacosSearchHeader({
    super.key,
    required this.title,
  ...
  @override
  State<StatefulWidget> createState() => _MacosSearchHeaderState();
}

class _MacosSearchHeaderState extends State<MacosSearchHeader> {
    ...
    return Row(
      ...
      children: [
        ...
        PopupMenuButton<String>(
          ...
          menuPadding: EdgeInsets.all(MacosScaler().scale(context, 8)),
          itemBuilder:
              (context) => [
                PopupMenuItem(
                  enabled: false,
                    ...
                    children: [
                      Icon(
                        _isAscending
                            ...
                            : FluentIcons.sortDescending,
                        color: Colors.white,
                        size: MacosScaler().scale(context, 16),
                      ),
                      SizedBox(width: MacosScaler().scale(context, 8)),
                      Text(
