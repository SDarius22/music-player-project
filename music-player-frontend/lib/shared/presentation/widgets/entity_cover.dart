...
import 'package:music_player_frontend/shared/presentation/widgets/triangle_clipper.dart';
import 'package:fluenticons/fluenticons.dart';
import 'package:provider/provider.dart';
import 'package:universal_platform/universal_platform.dart';

class EntityCover extends StatefulWidget {
  ...
  @override
  State<EntityCover> createState() => _EntityCoverState();
}

class _EntityCoverState extends State<EntityCover> {
  ...
  @override
  void didUpdateWidget(covariant EntityCover oldWidget) {
  ...
  Widget _getImageWidget(BuildContext context) {
    try {
      ...
      debugPrint(
        'EntityCover: failed to get image for entity ${widget.entity.getName()}: $e',
      );
    }
  ...
  void _handleBytesLoaded(Uint8List bytes) {
    ...
    try {
      ...
      debugPrint(
        'EntityCover: failed to update colors for ${widget.entity.getName()}: $e',
      );
    }
  }
